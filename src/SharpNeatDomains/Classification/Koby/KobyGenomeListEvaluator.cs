...
namespace SharpNeat.Domains.Classification.Koby
{
    ...
    /// </summary>
    public class KobyGenomeListEvaluator<TGenome> : IGenomeListEvaluator<TGenome>
        where TGenome : class, IGenome<TGenome>
    {
        readonly IGenomeDecoder<TGenome, IBlackBox> _genomeDecoder;
        readonly KobyBlackBoxEvaluator _phenomeEvaluator;
        ...
        /// </summary>
        public KobyGenomeListEvaluator(IGenomeDecoder<TGenome, IBlackBox> genomeDecoder,
                                           KobyBlackBoxEvaluator phenomeEvaluator,
                                           ParallelOptions options,
                                           bool enablePhenomeCaching,
                                           KobyDataProvider dataProvider)
        {
