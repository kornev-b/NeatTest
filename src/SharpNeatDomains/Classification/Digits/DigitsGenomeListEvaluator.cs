...
namespace SharpNeat.Domains.Classification.Digits
{
    ...
    /// </summary>
    public class DigitsGenomeListEvaluator<TGenome> : IGenomeListEvaluator<TGenome>
        where TGenome : class, IGenome<TGenome>
    {
        readonly IGenomeDecoder<TGenome, IBlackBox> _genomeDecoder;
        readonly DigitsBlackBoxEvaluator _phenomeEvaluator;
        ...
        /// </summary>
        public DigitsGenomeListEvaluator(IGenomeDecoder<TGenome, IBlackBox> genomeDecoder,
                                           DigitsBlackBoxEvaluator phenomeEvaluator,
                                           ParallelOptions options,
                                           bool enablePhenomeCaching,
                                           DigitsDataProvider dataProvider)
        {
