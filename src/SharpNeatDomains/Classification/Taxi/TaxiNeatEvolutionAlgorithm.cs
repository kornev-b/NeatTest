...
namespace SharpNeat.Domains.Classification.Taxi
{
    public class TaxiNeatEvolutionAlgorithm:NeatEvolutionAlgorithm<NeatGenome>
    {
        ...
        public TaxiNeatEvolutionAlgorithm(DataProvider dataProvider, NeatEvolutionAlgorithmParameters eaParams, ISpeciationStrategy<NeatGenome> speciationStrategy, IComplexityRegulationStrategy complexityRegulationStrategy) : base(eaParams, speciationStrategy, complexityRegulationStrategy)
        {
