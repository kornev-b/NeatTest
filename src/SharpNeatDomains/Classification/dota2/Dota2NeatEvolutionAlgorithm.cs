...
namespace SharpNeat.Domains.Classification.dota2
{
    public class Dota2NeatEvolutionAlgorithm:NeatEvolutionAlgorithm<NeatGenome>
    {
        ...
        public Dota2NeatEvolutionAlgorithm(Dota2DataProvider dataProvider, NeatEvolutionAlgorithmParameters eaParams, ISpeciationStrategy<NeatGenome> speciationStrategy, IComplexityRegulationStrategy complexityRegulationStrategy) : base(eaParams, speciationStrategy, complexityRegulationStrategy)
        {
